...
export const actions: ActionItem[] = [
  {
    ...
    source: "SLA Consistency Monitor (Sentinel)",
    reason: "Conflict C-001 detected between Sales collateral and CS fulfillment benchmarks.",
  ...
  },
  {
    ...
    source: "Policy Drift Sentinel (Sentinel)",
    reason: "EMEA collateral retains legacy monthly billing clauses contradictory to Decision #142.",
    evidenceIds: ["ev-pricing-sales", "ev-pricing-leadership"],
  ...
  },
  {
    ...
    reason: "Signal from engineering discussion proposed shift from Friday evening to Tuesday morning.",
  ...
  },
  {
    ...
    source: "Microsoft Teams · Security Review",
    reason: "Enforce Decision #160 policy to prevent on-call burnout while preserving Sev-1 response times.",
  ...
  },
  {
    ...
    source: "Project Portal Planning Sync",
    reason: "Support ticket analysis indicated 40% of queries relate to password and MFA resets.",
  ...
  {
    id: "act-006",
    title: "Grant temporary exemption for monthly billing on Tier-2 legacy renewals",
    description:
      "Proposed exception allowing existing EMEA mid-market accounts to renew on month-to-month contracts during Q4 transition window.",
    priority: "low",
    status: "dismissed",
    proposedAt: "2026-09-15T09:00:00",
    proposedBy: "person-james",
    source: "Sales Pipeline Review",
    reason: "Concerns about customer pushback during contract renegotiation.",
    ...
    relatedDecisionId: "dec-142",
    impactSummary:
      "Would have introduced bifurcated contract tracking and eroded cash-flow predictability gains.",
    affectedEntities: [
      { kind: "decision", id: "dec-142", label: "Decision #142 (Annual contracts)" },
      { kind: "project", id: "proj-atlas", label: "Project Atlas" },
    ],
    dismissedAt: "2026-09-15T14:30:00",
    dismissedBy: "Sarah Ahmed",
    dismissReason:
      "Executive leadership confirmed Decision #142 has zero exemptions; Finance transition discounts offer sufficient retention incentive without compromising policy consistency.",
  },
];
